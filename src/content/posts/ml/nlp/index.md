...
其中，第一步的数据获取，一般是用爬虫技术爬取数据，或者购买数据。我们这里准备好了<a href="/snofly-blog/files/nlp/data.zip" target="_blank">训练数据</a>，直接下载即可。**严郑声明，仅用于学习用途！**
...
> 笔者原本打算使用 python 代码来表示，但是<a href="/snofly-blog/files/nlp/pythonCode.zip" target="_blank">源代码</a>是 2019 年写，既没有输出中间结果(特征放内存里面了)，又多了模型评估的部分，不太适合本文的节奏，所以现在改用 nodejs 重写一遍。
